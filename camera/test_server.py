...
def test_invalid_warning_light_post_request(payload, error_message):
    ...
    if isinstance(error_message, list):
        ...
        assert error_message in "".join(data["message"]), f"Error message '{error_message}' should be in response. Response was: {data}"
...
def test_missing_payload_warning_light_post_request(default_payload):
    ...
    assert data["received_data"] == default_payload , "Response should match default payload"
