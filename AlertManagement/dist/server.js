...
const alertRoutes_1 = require("./routes/alertRoutes"); // Import the alert routes
...
app.use('/api/alerts', alertRoutes_1.alertRoutes); // Use the notification routes under '/api/notifications'
